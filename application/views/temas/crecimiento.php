<p class="bd-lead" id="crecimiento">Formación y crecimiento de los huesos</p>
<div class="row">
	<div class="col">
		<p>El embrión no contiene huesos sino estructuras de cartílago hialino. De manera gradual se produce la osificación y osteogénesis, a partir de centros de osificación constituidos por cúmulos de células especiales formadoras de hueso denominadas osteoblastos.</p>
		<p>El aparato de Golgi de los osteoblastos se especializa en la síntesis y secreción de mucopolisacáridos, y su retículo endoplasmático elabora y secreta una proteína denominada colágeno. Los mucopolisacáridos se acumulan alrededor de cada osteoblasto y los haces de fibras colágenas de embeben de esa sustancia. Todo esto junto constituye la matriz ósea; las fibras colágenas le dan resistencia.</p>
		<div class="row">
			<div class="col">
				A medida que se forma la matriz ósea, empiezan a depositarse en ellas compuestos inorgánicos como sales de calcio, que le dan al hueso su dureza característica. O sea que la osificación consta de dos procesos:
				<ol>
					<li>La <b>síntesis de matriz ósea</b> orgánica por los osteoblastos</li>
					<li>La <b>calcificación</b> de la matriz</li>
				</ol>
			</div>
			<div class="col">
